...
<div id="container">
	<div id="left"><br><br><br>
		...
		<br>
		<h3 style="color: blue;margin: 50px">BOOK DITAILS</h3>
		<?php
		   $c= $_GET['id'];
		...
		?>
			...
			<div id="a">
					    ...
					    <h3><font color="blue">Name :</font><?php echo $name; ?><br>
					    	<font color="blue">Price :</font><?php echo $price; ?></h3>
					<a href="p2.php?id=<?php echo $id; ?>" style="width: 300px; height: 100px; padding: 5px; background-color: white; border-radius: 5px">Buy Now</a>
